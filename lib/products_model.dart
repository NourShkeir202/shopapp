class product_model {
  ...
  product_model({int id, String title, double price, String description, String category, String image, Rating rating}) {
    this._id = id;
    this._title = title;
    this._price = price;
  ...
  product_model.fromJson(Map<String, dynamic> json) {
    ...
    _image = json['image'];
    _rating = json['rating'] != null ? new Rating.fromJson(json['rating']) : null;
  }
